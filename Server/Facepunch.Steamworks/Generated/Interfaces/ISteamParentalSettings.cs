...
namespace Steamworks
{
	internal unsafe partial class ISteamParentalSettings : SteamInterface
	{
		...
		[DllImport( "steam_api.dll", EntryPoint = "SteamAPI_SteamParentalSettings_v001", CallingConvention = Platform.CC)]
		...
		#region FunctionMeta
		[DllImport( "steam_api.dll", EntryPoint = "SteamAPI_ISteamParentalSettings_BIsParentalLockEnabled", CallingConvention = Platform.CC)]
		...
		#region FunctionMeta
		[DllImport( "steam_api.dll", EntryPoint = "SteamAPI_ISteamParentalSettings_BIsParentalLockLocked", CallingConvention = Platform.CC)]
		[return: MarshalAs( UnmanagedType.I1 )]
		...
		#region FunctionMeta
		[DllImport( "steam_api.dll", EntryPoint = "SteamAPI_ISteamParentalSettings_BIsAppBlocked", CallingConvention = Platform.CC)]
		[return: MarshalAs( UnmanagedType.I1 )]
		...
		#region FunctionMeta
		[DllImport( "steam_api.dll", EntryPoint = "SteamAPI_ISteamParentalSettings_BIsAppInBlockList", CallingConvention = Platform.CC)]
		[return: MarshalAs( UnmanagedType.I1 )]
		...
		#region FunctionMeta
		[DllImport( "steam_api.dll", EntryPoint = "SteamAPI_ISteamParentalSettings_BIsFeatureBlocked", CallingConvention = Platform.CC)]
		[return: MarshalAs( UnmanagedType.I1 )]
		...
		#region FunctionMeta
		[DllImport( "steam_api.dll", EntryPoint = "SteamAPI_ISteamParentalSettings_BIsFeatureInBlockList", CallingConvention = Platform.CC)]
		[return: MarshalAs( UnmanagedType.I1 )]
